    ...
    const handleSubmit = (e) => {
        ...
        createUserWithEmailAndPassword(auth, email, password)
            .then(result => {
                ...
                fetch('https://obscure-journey-61930.herokuapp.com/entrepreneur/', {
                    method: 'POST',
                    headers: {
                    ...
                    .then(data => {
                        if (data.insertedId) {
                            alert('Successfully added Entrepreneur')
                            e.target.reset();
                        }
                    })
...
export default EntrepreneurSingup;
